...
const About = () => (
  <div>
    {/* <Hero backgroundImage="https://i.imgur.com/qkdpN.jpg">
      <h1>Meet Cindy</h1>
      <h2>Aloha the Good Boys and Girls</h2>
    </Hero> */}
    <Carousel>
  <Carousel.Item>
    <img
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption>
      ...
      <p>Innovative ~ Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
    ...
    <Carousel.Caption>
      ...
      <p>Relevant ~ Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
    </Carousel.Caption>
  </Carousel.Item>
</Carousel>
